...
const Trailerfunc = function (id) {
  return `<iframe name="framez" id="framez" class="youtubePlayer" src="https://vidsrc.cc/v3/embed/tv/${id}/1/1?autoPlay=true&title=true&poster=true&mute=false&nextbutton=true&sandbox=true" gesture="media" width="100%" height="100%" loading="lazy" frameborder="0" allowfullscreen></iframe>`;
...
\n\n#tvseriesclip\t#freetvseries\t#highlights\t#topcontent\t#tvshow\t#mustwatchtvshow\t#topratingtvshow</div>
      ...
      <span class="copyLink" id="copy" onclick="copyToClipboard('#textWatchTv-1')">
        ...
        <a style="display:none;" class="playLink" href="${url}"><button class="play_btn"><svg xmlns="http://www.w3.org/2000/svg" width="19" height="19"
                fill="currentColor" class="path_btn bi-play-fill" viewBox="0 0 16 16">
                <path class="path_btnn"
                    d="m11.596 8.697-6.363 3.692c-.54.313-1.233-.066-1.233-.697V4.308c0-.63.692-1.01 1.233-.696l6.363 3.692a.802.802 0 0 1 0 1.393z">
                </path>
            </svg>Seasons List</button></a> 
    </div>
